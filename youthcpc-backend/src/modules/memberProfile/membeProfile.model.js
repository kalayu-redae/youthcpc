...
module.exports = (sequelize, DataTypes) => {
    ...
    MemberProfile.init({
        ...
        membershipNumber: { type: DataTypes.STRING(50), allowNull: true, unique: true },
        ...
        volunteerExperience: { type: DataTypes.TEXT },
        aspirations: { type: DataTypes.TEXT },
        ...
        verifiedBy: { type: DataTypes.INTEGER.UNSIGNED },
